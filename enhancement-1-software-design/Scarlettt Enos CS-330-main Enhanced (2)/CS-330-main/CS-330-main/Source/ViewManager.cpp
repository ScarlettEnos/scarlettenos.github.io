 ...
 ***********************************************************/
//Milestone Three Camera Adjustments
GLFWwindow* ViewManager::CreateDisplayWindow(const char* windowTitle)
{
	...
	// here I added a callback that is used to receive mouse scroll wheel events
...
//I added the Mouse_Scroll_Wheel callback 
//This will call from GLFW whenever and the mouse wheel will scroll within the active display window
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	//Here I added the camera panning up and down feature
	...
	//here I added perspective and orthographic displays
	//the view can be toggled when pressing P (perspective) or O (orthographic) 
